...
export const ProductCard = () => {
    return (
        <div className="bg-white rounded-xl w-11/12 flex flex-col sm:w-6/6 sm:flex-row lg:w-6/12 text-dark-grayish-blue">
            ...
            <div className="p-5 gap-y-4 flex flex-col text-wrap justify-center">
                ...
                <button className="rounded-md bg-dark-cyan py-3 text-white flex flex-row items-center justify-center gap-x-3
